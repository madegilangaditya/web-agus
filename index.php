...
<?php
	...
	try {
		...
		$sel = $database->sql($db, "select tb_barang.id_barang, tb_barang.kd_barang, tb_barang.nama_barang, tb_barang.harga, 
			tb_gambar.gambar from tb_barang 
			inner join tb_gambar on tb_gambar.id_barang=tb_barang.id_barang group by tb_barang.id_barang DESC limit 12"
        , array(""), "rows");
	} catch (Exception $e) {
...
<!-- banner-bottom -->
		<div class="container">
			<div class="mega_nav" style="padding:0.3em; margin:1em;">
			<h2 style="margin0.5em;">Produk Terbaru</h2>
		</div>
	</div>
			...
			<div class="product-one">
				...
				<div class="col-md-2 product-left">
					<div class="p-one simpleCart_shelfItem jwe">
						<a href="single.php?id=<?php echo "$row[id_barang]"; ?>">
							<img src="images/barang/<?php echo "$row[gambar]"; ?>" 
							alt="<?php echo "$row[gambar]-$row[nama_barang]"; ?>" class="img-responsive" />
							<div class="mask">
								<span>View</span>
							</div>
						</a>
